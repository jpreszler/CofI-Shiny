...
cbind.data.frame(lseq,left,right) %>% kable("latex", longtable = TRUE, booktabs=TRUE, caption = "Confirmed Attendees") %>% 
...
cbind.data.frame(lseq2,left2,right2) %>% kable("latex", longtable = TRUE, booktabs=TRUE, caption = "Possible Attendees") %>% 
  kable_styling(latex_options = c("stiped", "repeat_header"))
```